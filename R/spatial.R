...
#'
#' @param x vector of \code{x} vertices
#' @param y vector of \code{y} vertices
...
#' points that go over the course of the polygon edges.
#'
...
#' @examples
#' # make unit square
#' polygon_points(c(-1, -1, 1, 1), c(-1, 1, 1, -1))
